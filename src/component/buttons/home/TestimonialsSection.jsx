    ...
    ">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="bg-linear-to-br from-emerald-50/10 to-green-50/5 rounded-2xl p-6 shadow text-center">
          ...
          <div className="bg-linear-to-br from-emerald-50/10 to-green-50/5 rounded-2xl p-6 shadow text-center">
            <FaHandsHelping className="text-green-500 text-3xl mx-auto mb-2" />
            <h3 className="text-3xl font-bold text-green-600">3K+</h3>
          ...
          <div className="bg-linear-to-br from-emerald-50/10 to-green-50/5 rounded-2xl p-6 shadow text-center">
            <FaStar className="text-green-500 text-3xl mx-auto mb-2" />
            <h3 className="text-3xl font-bold text-green-600">4.9/5</h3>
